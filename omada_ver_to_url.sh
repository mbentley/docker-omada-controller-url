...
case "${1}" in
  ...
  beta-5.14.30.7)
    ...
    ;;
  beta|beta-5.14.32.2)
    OMADA_URL="https://static.tp-link.com/upload/beta/2024/202409/20240926/Omada_SDN_Controller_v5.14.32.2_Linux_x64_tar.gz_Pre-release%20(Released%20on%20Sep%2026th,%202024).zip"
    ;;
  *)
    exit 1
    ;;
